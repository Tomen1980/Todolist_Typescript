...
//yang pertama kali muncul pada overfly
const defaultStyle = {
...
const DeleteModal: React.FC<Props> = ({inProp,taskStatus,onCancel,onDelete}) =>{
                    ...
                    <div className=' flex flex-col h-full justify-between '>
                        <section className='flex flex-row justify-between'>
                            ...
                            <p className="text-darkPurple text-sm subpixel-antialiased tracking-wide font-bold whitespace-normal">
                                {taskStatus === 'uncompleted' && 'this task is not completed delete, deleted ?'}
